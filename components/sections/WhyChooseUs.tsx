...
const REASONS = [
  ...
  { num: "04", title: "On-Time Handover", desc: "We utilize strict project management timelines common in the commercial sector to ensure your residential or multi-floor project finishes on schedule." }
];

export default function WhyChooseUs() {
  return (
    <div className="grid grid-cols-4 max-[1100px]:grid-cols-2 max-[600px]:grid-cols-1 gap-6">
      {REASONS.map((r, i) => (
        <Reveal key={i}>
