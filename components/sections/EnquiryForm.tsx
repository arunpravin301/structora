    ...
    <form onSubmit={submit} className="space-y-6">
      {[["name","Your name","text"],["phone","Phone number","tel"],["email","Email (optional)","email"]].map(([n,l,t])=>(
        <div key={n} className="group transition-colors">
          <label className="block text-xs text-slate group-focus-within:text-brand transition-colors mb-2 tracking-wide uppercase font-semibold">{l}</label>
      ...
      <div className="group transition-colors">
        <label className="block text-xs text-slate group-focus-within:text-brand transition-colors mb-2 tracking-wide uppercase font-semibold">Message</label>
